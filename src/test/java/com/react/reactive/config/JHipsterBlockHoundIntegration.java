...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.react.reactive.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.react.reactive.security.DomainUserDetailsService", "createSpringSecurityUser");
